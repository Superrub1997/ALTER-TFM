...
/**
 * This is the item provider adapter for a {@link Gameloop.AttributeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueItemProvider extends ValueItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeValue_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeValue_class_feature", "_UI_AttributeValue_type"),
				 GameloopPackage.Literals.ATTRIBUTE_VALUE__CLASS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GameloopPackage.Literals.ATTRIBUTE_VALUE__ATTRIBUTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((AttributeValue)object).getClass_();
