...
/**
 * This is the item provider adapter for a {@link Gameloop.Game} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GameItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GameloopPackage.Literals.GAME__WIN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GameloopPackage.Literals.GAME__LOSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GameloopPackage.Literals.GAME__START,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GameloopPackage.Literals.GAME__OBJ_INIT);
			childrenFeatures.add(GameloopPackage.Literals.GAME__SCORE);
			childrenFeatures.add(GameloopPackage.Literals.GAME__COLLISIONS);
			childrenFeatures.add(GameloopPackage.Literals.GAME__ACTIONS_TRIGGERS);
			childrenFeatures.add(GameloopPackage.Literals.GAME__GAMEPAD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GameloopPackage.Literals.GAME__OBJ_INIT,
				 GameloopFactory.eINSTANCE.createObjInit()));

		newChildDescriptors.add
			(createChildParameter
				(GameloopPackage.Literals.GAME__SCORE,
				 GameloopFactory.eINSTANCE.createScoreSystem()));

		newChildDescriptors.add
			(createChildParameter
				(GameloopPackage.Literals.GAME__COLLISIONS,
				 GameloopFactory.eINSTANCE.createCollision()));

		newChildDescriptors.add
			(createChildParameter
				(GameloopPackage.Literals.GAME__ACTIONS_TRIGGERS,
				 GameloopFactory.eINSTANCE.createTrigger()));

		newChildDescriptors.add
			(createChildParameter
				(GameloopPackage.Literals.GAME__GAMEPAD,
				 GameloopFactory.eINSTANCE.createGamePad()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return GameloopEditPlugin.INSTANCE;
	}
