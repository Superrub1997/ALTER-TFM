...
/**
 * This is the item provider adapter for a {@link Ontologicals.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNoSCNPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.CLASS__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.CLASS__ABSTRACT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the No SCN feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNoSCNPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_noSCN_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_noSCN_feature", "_UI_Class_type"),
				 OntologicalsPackage.Literals.CLASS__NO_SCN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.CLASS__SUPERCLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntologicalsPackage.Literals.CLASS__ATTRIBUTES);
			childrenFeatures.add(OntologicalsPackage.Literals.CLASS__REFERENCES);
		}
	...
	public String getText(Object object) {
		String label = ((Ontologicals.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ontologicals.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologicalsPackage.Literals.CLASS__ATTRIBUTES,
				 OntologicalsFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(OntologicalsPackage.Literals.CLASS__REFERENCES,
				 OntologicalsFactory.eINSTANCE.createReference()));
	}
