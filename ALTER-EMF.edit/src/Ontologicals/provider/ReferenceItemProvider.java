...
/**
 * This is the item provider adapter for a {@link Ontologicals.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.REFERENCE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContaintmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_containtment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_containtment_feature", "_UI_Reference_type"),
				 OntologicalsPackage.Literals.REFERENCE__CONTAINTMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_min_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_min_feature", "_UI_Reference_type"),
				 OntologicalsPackage.Literals.REFERENCE__MIN,
				 true,
				 false,
				 false,
	...
	protected void addMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_max_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_max_feature", "_UI_Reference_type"),
				 OntologicalsPackage.Literals.REFERENCE__MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.REFERENCE__TARGET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologicalsPackage.Literals.REFERENCE__OPPOSITE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
