 ...
 * </p>
 * <ul>
 *   <li>{@link Gameloop.impl.ScoreSystemImpl#getStart <em>Start</em>}</li>
 *   <li>{@link Gameloop.impl.ScoreSystemImpl#getFinish <em>Finish</em>}</li>
 *   <li>{@link Gameloop.impl.ScoreSystemImpl#getLives <em>Lives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScoreSystemImpl extends MinimalEObjectImpl.Container implements ScoreSystem {
	...
	protected EClass eStaticClass() {
		return GameloopPackage.Literals.SCORE_SYSTEM;
	}
	...
	public void setStart(int newStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.SCORE_SYSTEM__START, oldStart, start));
	}
	...
	public void setFinish(int newFinish) {
		...
		finish = newFinish;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.SCORE_SYSTEM__FINISH, oldFinish, finish));
	}
	...
	public void setLives(int newLives) {
		...
		lives = newLives;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.SCORE_SYSTEM__LIVES, oldLives, lives));
	}
