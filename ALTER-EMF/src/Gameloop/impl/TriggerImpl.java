 ...
 * </p>
 * <ul>
 *   <li>{@link Gameloop.impl.TriggerImpl#getName <em>Name</em>}</li>
 *   <li>{@link Gameloop.impl.TriggerImpl#getScoreChange <em>Score Change</em>}</li>
 *   <li>{@link Gameloop.impl.TriggerImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link Gameloop.impl.TriggerImpl#getTimeTrigger <em>Time Trigger</em>}</li>
 *   <li>{@link Gameloop.impl.TriggerImpl#getPhysicChanges <em>Physic Changes</em>}</li>
 *   <li>{@link Gameloop.impl.TriggerImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
	 ...
	 * @ordered
	 */
	protected static final BasicActions ACTION_EDEFAULT = BasicActions.START;
	...
	protected EClass eStaticClass() {
		return GameloopPackage.Literals.TRIGGER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.TRIGGER__NAME, oldName, name));
	}
	...
	public void setScoreChange(int newScoreChange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.TRIGGER__SCORE_CHANGE, oldScoreChange, scoreChange));
	}
	...
	public void setMessage(String newMessage) {
		...
		message = newMessage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.TRIGGER__MESSAGE, oldMessage, message));
	}
	...
	public void setTimeTrigger(int newTimeTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.TRIGGER__TIME_TRIGGER, oldTimeTrigger, timeTrigger));
	}
	...
	public EList<PhysicChange> getPhysicChanges() {
		if (physicChanges == null) {
			physicChanges = new EObjectContainmentEList<PhysicChange>(PhysicChange.class, this, GameloopPackage.TRIGGER__PHYSIC_CHANGES);
		}
	...
	public void setAction(BasicActions newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GameloopPackage.TRIGGER__ACTION, oldAction, action));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GameloopPackage.TRIGGER__PHYSIC_CHANGES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GameloopPackage.TRIGGER__NAME:
				return getName();
			case GameloopPackage.TRIGGER__SCORE_CHANGE:
				return getScoreChange();
			case GameloopPackage.TRIGGER__MESSAGE:
				return getMessage();
			case GameloopPackage.TRIGGER__TIME_TRIGGER:
				return getTimeTrigger();
			case GameloopPackage.TRIGGER__PHYSIC_CHANGES:
				return getPhysicChanges();
			case GameloopPackage.TRIGGER__ACTION:
				return getAction();
		}
