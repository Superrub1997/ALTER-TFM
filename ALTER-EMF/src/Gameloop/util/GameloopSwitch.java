 ...
 * @generated
 */
public class GameloopSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GameloopPackage.CONDITION: {
