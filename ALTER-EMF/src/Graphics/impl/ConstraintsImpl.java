 ...
 * </p>
 * <ul>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getPlanes <em>Planes</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getIlumination <em>Ilumination</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getSizeMax <em>Size Max</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getSizeMin <em>Size Min</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getSizeInit <em>Size Init</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#isOverlapping <em>Overlapping</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getXToOriginPos <em>XTo Origin Pos</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getYToOriginPos <em>YTo Origin Pos</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getZToOriginPos <em>ZTo Origin Pos</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getText <em>Text</em>}</li>
 *   <li>{@link Graphics.impl.ConstraintsImpl#getTextColor <em>Text Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintsImpl extends MinimalEObjectImpl.Container implements Constraints {
	...
	protected EClass eStaticClass() {
		return GraphicsPackage.Literals.CONSTRAINTS;
	}
	...
	public void setPlanes(Planes newPlanes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__PLANES, oldPlanes, planes));
	}
	...
	public void setIlumination(String newIlumination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__ILUMINATION, oldIlumination, ilumination));
	}
	...
	public void setSizeMax(double newSizeMax) {
		...
		sizeMax = newSizeMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__SIZE_MAX, oldSizeMax, sizeMax));
	}
	...
	public void setSizeMin(double newSizeMin) {
		...
		sizeMin = newSizeMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__SIZE_MIN, oldSizeMin, sizeMin));
	}
	...
	public void setSizeInit(double newSizeInit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__SIZE_INIT, oldSizeInit, sizeInit));
	}
	...
	public void setOverlapping(boolean newOverlapping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__OVERLAPPING, oldOverlapping, overlapping));
	}
	...
	public void setXToOriginPos(double newXToOriginPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__XTO_ORIGIN_POS, oldXToOriginPos, xToOriginPos));
	}
	...
	public void setYToOriginPos(double newYToOriginPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__YTO_ORIGIN_POS, oldYToOriginPos, yToOriginPos));
	}
	...
	public void setZToOriginPos(double newZToOriginPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__ZTO_ORIGIN_POS, oldZToOriginPos, zToOriginPos));
	}
	...
	public void setRotation(int newRotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__ROTATION, oldRotation, rotation));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__TEXT, oldText, text));
	}
	...
	public void setTextColor(String newTextColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.CONSTRAINTS__TEXT_COLOR, oldTextColor, textColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphicsPackage.CONSTRAINTS__PLANES:
				return getPlanes();
			case GraphicsPackage.CONSTRAINTS__ILUMINATION:
				return getIlumination();
			case GraphicsPackage.CONSTRAINTS__SIZE_MAX:
				return getSizeMax();
			case GraphicsPackage.CONSTRAINTS__SIZE_MIN:
				return getSizeMin();
			case GraphicsPackage.CONSTRAINTS__SIZE_INIT:
				return getSizeInit();
			case GraphicsPackage.CONSTRAINTS__OVERLAPPING:
				return isOverlapping();
			case GraphicsPackage.CONSTRAINTS__XTO_ORIGIN_POS:
				return getXToOriginPos();
			case GraphicsPackage.CONSTRAINTS__YTO_ORIGIN_POS:
				return getYToOriginPos();
			case GraphicsPackage.CONSTRAINTS__ZTO_ORIGIN_POS:
				return getZToOriginPos();
			case GraphicsPackage.CONSTRAINTS__ROTATION:
				return getRotation();
			case GraphicsPackage.CONSTRAINTS__TEXT:
				return getText();
			case GraphicsPackage.CONSTRAINTS__TEXT_COLOR:
				return getTextColor();
		}
