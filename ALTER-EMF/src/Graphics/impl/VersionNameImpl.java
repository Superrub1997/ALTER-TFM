...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Version Name</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Graphics.impl.VersionNameImpl#getV1 <em>V1</em>}</li>
 *   <li>{@link Graphics.impl.VersionNameImpl#getV2 <em>V2</em>}</li>
 *   <li>{@link Graphics.impl.VersionNameImpl#getV3 <em>V3</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionNameImpl extends MinimalEObjectImpl.Container implements VersionName {
	/**
	...
	protected EClass eStaticClass() {
		return GraphicsPackage.Literals.VERSION_NAME;
	}
	...
	public void setV1(String newV1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.VERSION_NAME__V1, oldV1, v1));
	}
	...
	public void setV2(String newV2) {
		...
		v2 = newV2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.VERSION_NAME__V2, oldV2, v2));
	}
	...
	public void setV3(String newV3) {
		...
		v3 = newV3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicsPackage.VERSION_NAME__V3, oldV3, v3));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphicsPackage.VERSION_NAME__V1:
				return getV1();
			case GraphicsPackage.VERSION_NAME__V2:
				return getV2();
			case GraphicsPackage.VERSION_NAME__V3:
				return getV3();
		}
