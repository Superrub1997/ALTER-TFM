 ...
 * <!-- end-user-doc -->
 * @see Ontologicals.OntologicalsPackage
 * @generated
 */
public class OntologicalsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static OntologicalsPackage modelPackage;
	 ...
	 * @generated
	 */
	public OntologicalsSwitch() {
		if (modelPackage == null) {
			modelPackage = OntologicalsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OntologicalsPackage.CLASS: {
				Ontologicals.Class class_ = (Ontologicals.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(Ontologicals.Class object) {
		return null;
	}
