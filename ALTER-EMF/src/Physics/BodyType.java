 ...
 * <!-- end-user-doc -->
 * @see Physics.PhysicsPackage#getBodyType()
 * @model
 * @generated
 */
public enum BodyType implements Enumerator {
	...
	/**
	 * The '<em><b>Kinematic</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #KINEMATIC_VALUE
	 * @generated
	 * @ordered
	 */
	KINEMATIC(2, "kinematic", "kinematic");
	...
	/**
	 * The '<em><b>Kinematic</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #KINEMATIC
	...
	public static BodyType get(int value) {
		switch (value) {
			...
			case KINEMATIC_VALUE: return KINEMATIC;
		}
		return null;
	}
