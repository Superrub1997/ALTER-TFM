 ...
 * </p>
 * <ul>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getMass <em>Mass</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getBodyType <em>Body Type</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getCharge <em>Charge</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getFriction <em>Friction</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getRollingFriction <em>Rolling Friction</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getRestitution <em>Restitution</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getDamping <em>Damping</em>}</li>
 *   <li>{@link Physics.impl.PhysicBodyImpl#getAngularDamping <em>Angular Damping</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PhysicBodyImpl extends MinimalEObjectImpl.Container implements PhysicBody {
	...
	protected EClass eStaticClass() {
		return PhysicsPackage.Literals.PHYSIC_BODY;
	}
	...
	public void setMass(double newMass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__MASS, oldMass, mass));
	}
	...
	public void setBodyType(BodyType newBodyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__BODY_TYPE, oldBodyType, bodyType));
	}
	...
	public void setCharge(double newCharge) {
		...
		charge = newCharge;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__CHARGE, oldCharge, charge));
	}
	...
	public void setFriction(double newFriction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__FRICTION, oldFriction, friction));
	}
	...
	public void setRollingFriction(double newRollingFriction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__ROLLING_FRICTION, oldRollingFriction, rollingFriction));
	}
	...
	public void setRestitution(double newRestitution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__RESTITUTION, oldRestitution, restitution));
	}
	...
	public void setDamping(double newDamping) {
		...
		damping = newDamping;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__DAMPING, oldDamping, damping));
	}
	...
	public void setAngularDamping(double newAngularDamping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicsPackage.PHYSIC_BODY__ANGULAR_DAMPING, oldAngularDamping, angularDamping));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PhysicsPackage.PHYSIC_BODY__MASS:
				return getMass();
			case PhysicsPackage.PHYSIC_BODY__BODY_TYPE:
				return getBodyType();
			case PhysicsPackage.PHYSIC_BODY__CHARGE:
				return getCharge();
			case PhysicsPackage.PHYSIC_BODY__FRICTION:
				return getFriction();
			case PhysicsPackage.PHYSIC_BODY__ROLLING_FRICTION:
				return getRollingFriction();
			case PhysicsPackage.PHYSIC_BODY__RESTITUTION:
				return getRestitution();
			case PhysicsPackage.PHYSIC_BODY__DAMPING:
				return getDamping();
			case PhysicsPackage.PHYSIC_BODY__ANGULAR_DAMPING:
