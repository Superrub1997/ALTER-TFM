...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "bin/alterar/acceleo/main/generate";
    ...
    public void doGeneratePlugin(String uri, String output) {
      	 try {            
                  ...
                  generator.addPropertiesFile(uri);
                  generator.addPropertiesFile(output);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if(!isInWorkspace(ArdslPackage.class))
        	resourceSet.getPackageRegistry().put(ArdslPackage.eNS_URI,
        			ArdslPackage.eINSTANCE);
        /*
         * If you want to change the content of this method, do NOT forget to change the "@generated"
         * tag in the Javadoc of this method to "@generated NOT". Without this new tag, any compilation
         * of the Acceleo module with the main template that has caused the creation of this class will
